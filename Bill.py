...
class Bill_App:
    def __init__(self,root):
        ...
        F1=LabelFrame(self.root,bd=10,relief=GROOVE ,text="Customer Details", font=("times new roman", 30,"bold"),fg="gold", bg=bg_color)
        ...
        F2.place(x=5,y=200,width=400, height=380)
        ...
        Face_Cream_lbl=Label(F2, text="FaceCream", font=("times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        ...
        F3.place(x=340,y=200,width=400, height=380)
        ...
        #==================Cold Drink Frame=======================
        F4=LabelFrame(self.root,bd=10,relief=GROOVE ,text="Cold_Drinks", font=("times new roman", 15,"bold"),fg="gold", bg=bg_color)
        F4.place(x=670,y=200,width=400, height=380)
        ...
        F5.place(x=1010,y=200,width=500, height=380)
        ...
        F6.place(x=0,y=580,relwidth=1, height=200)
        ...
        m3=Label(F6, text="Total Cold_Drink Price",bg =bg_color, fg="white", font =("times new roman", 14, "bold")).grid(row=2, column=0, padx=20, pady=1, sticky="w")
        ...
        c3=Label(F6, text="Cold_Drink Tax",bg =bg_color, fg="white", font =("times new roman", 14, "bold")).grid(row=2, column=2, padx=20, pady=1, sticky="w")
        ...
        total_btn=Button(btn_F,command=self.total, text="Total", bg="cadetblue", fg="white",bd=2, pady=10, width=8, font="arial 15 bold").grid(row=0, column=0, padx=5, pady=5)
        GBill_btn=Button(btn_F, text="Gen_Bill",command=self.bill_area, bg="cadetblue", fg="white",bd=2, pady=10, width=8, font="arial 15 bold").grid(row=0, column=1, padx=5, pady=5)
        Clear_btn=Button(btn_F, text="Clear",command=self.clear_data, bg="cadetblue", fg="white",bd=2, pady=10, width=8, font="arial 15 bold").grid(row=0, column=2, padx=5, pady=5)
        Exit_btn=Button(btn_F, text="Exit",command=self.Exit_app, bg="cadetblue", fg="white",bd=2, pady=10, width=8, font="arial 15 bold").grid(row=0, column=3, padx=5, pady=5)
        self.welcome_bill()
    ...
    def welcome_bill(self):
        ...
        self.txtarea.insert(END, "\tWelcome Tanuja Retail\n")
    ...
    def bill_area(self):
        if self.c_name.get=="" or self.c_phon.get()=="":
            ...
            if self.daal.get()!=0:
                self.txtarea.insert(END, f"\n Face daal\t\t{self.daal.get()}\t\t{self.g_d_p}")
            if self.wheat.get()!=0:
